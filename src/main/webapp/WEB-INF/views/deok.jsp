...
<!-- jVectorMap -->
<script src="/resources/js/maps/jquery-jvectormap-world-mill-en.js"></script>
<script src="/resources/js/maps/jquery-jvectormap-us-aea-en.js"></script>
<script src="/resources/js/maps/gdp-data.js"></script>
<script>
    $(document).ready(function(){
